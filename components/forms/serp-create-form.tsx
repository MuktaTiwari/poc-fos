  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div>
        ...
        {errors.type && <p className="mt- text-sm text-red-500">{errors.type.message}</p>}
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          {errors.panNo && (
            <p className="mt- text-sm text-red-500">{errors.panNo.message}</p>
          )}
        </div>
        <div>
          ...
          {errors.tanNo && (
            <p className="mt- text-sm text-red-500">{errors.tanNo.message}</p>
          )}
        </div>
        <div>
          ...
          {errors.gstNo && (
            <p className="mt- text-sm text-red-500">{errors.gstNo.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          {errors.pincode && (
            <p className="mt- text-sm text-red-500">{errors.pincode.message}</p>
          )}
        </div>
        <div>
