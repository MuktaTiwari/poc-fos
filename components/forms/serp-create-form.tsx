...
export default function SerpForm({
  ...
  return (
    <FormCard title={initialData ? "Edit SERP" : "Create SERP"}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex gap-4">
          ...
          <div className="w-1/2">
            ...
            {errors.parentId && (
              <p className="mt-2 text-sm text-red-500">{errors.parentId.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            {errors.panNo && (
              <p className="mt-2 text-sm text-red-500">{errors.panNo.message}</p>
            )}
          </div>
          <div>
            ...
            {errors.tanNo && (
              <p className="mt-2 text-sm text-red-500">{errors.tanNo.message}</p>
            )}
          </div>
          <div>
            ...
            {errors.gstNo && (
              <p className="mt-2 text-sm text-red-500">{errors.gstNo.message}</p>
            )}
          </div>
        </div>
